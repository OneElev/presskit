...
echo '					<div class="uk-grid">
						<div class="uk-width-medium-2-6">
							...
							<p>
								...
								<a href="../presskit/'. $languageQuery .'">'. COMPANY_TITLE .'</a><br/>
...
echo '					<hr>
					...
					<p>
						...
						'. tlHtml('More information on %s, our logo & relevant media are available <a href="%s/presskit/">here</a>.', COMPANY_TITLE, '../'. $languageQuery). '
					</p>
